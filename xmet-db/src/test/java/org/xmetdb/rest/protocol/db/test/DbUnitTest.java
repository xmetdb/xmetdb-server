...
package org.xmetdb.rest.protocol.db.test;
...
import org.xmetdb.rest.protocol.db.DbCreateDatabase;
...
//SET NAMES utf8	        
    ...
    public void setUpDatabase(String xmlfile) throws Exception {
    	...
    	initDB("src/test/resources/org/xmetdb/xmet/tables.xml",DatabaseOperation.DELETE_ALL,true);

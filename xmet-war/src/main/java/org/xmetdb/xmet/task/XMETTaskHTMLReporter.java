...
public class XMETTaskHTMLReporter<USERID> extends TaskHTMLReporter<USERID> {
	...
	public XMETTaskHTMLReporter(ITaskStorage<USERID> storage,Request ref,ResourceDoc doc) {
		this(storage,ref,doc,null);
	}
	public XMETTaskHTMLReporter(ITaskStorage<USERID> storage,Request ref,ResourceDoc doc,HTMLBeauty htmlbeauty) {
